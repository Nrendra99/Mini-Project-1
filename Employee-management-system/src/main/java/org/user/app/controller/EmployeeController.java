...
public class EmployeeController {
     ...
     * @param model Model object to hold data for the view.
     * @return The name of the view template to render, typically the form view in case of validation errors,
     *         or the same form view with a success message if the employee is added successfully.
     */
    @PostMapping("/process")
    ...
    public String addEmpProcess(@Valid Employee employee, BindingResult result, Model model) {
        if (result.hasErrors()) {
            return "AddEmployee"; // Return the form view to allow the exception handler to manage validation errors
        }
